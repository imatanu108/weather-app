    ...
    if (autoSearchData && autoSearchData.length > 0) {
        return (
            <div className='bg-[rgba(44,57,69,0.35)] text-base p-1 rounded-xl w-80'>
                <div className='text-center pt-1 text-[rgb(182,222,235)]'>
                    Suggestions
                </div>
                {autoSearchData.map((locationData, index) => {
                    return (
                        <div
                            ...
                            className='m-1 py-1 px-2 text-[rgb(182,222,235)] cursor-pointer hover:bg-[rgb(55,173,197)] hover:text-slate-50 rounded-md transition duration-200'
                        >
